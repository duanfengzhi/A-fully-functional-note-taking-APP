...
public class SlideButton extends View {
    ...
    //椭圆的边框宽度
    private static final int strokeLineWidth =6;
    //圆的边框宽度
    private static final int circleStrokeWidth = 6;
    ...
    private void init(Context context) {
        ...
        strokeLineColor_int = parseColor(StrokeLineColor);
        strokeNoCheckedSolidColor_int = parseColor(StrokeSolidColor);
        circleStrokeColor_int = parseColor(CircleStrokeColor);
        circleChecked_int = parseColor(CircleCheckedColor);
        circleNoCheckedColor_int = parseColor(CircleNoCheckedColor);
    }
